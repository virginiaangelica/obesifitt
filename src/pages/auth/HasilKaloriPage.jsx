    ...
    <section className="flex flex-col min-h-screen bg-white">
      ...
      <nav className="flex justify-between items-center py-4 px-12 bg-white">
        ...
        <div className="flex items-center space-x-6">
          ...
          <a href="#" className="text-gray-700 hover:underline">Artikel</a>
          <a href="#" className="text-gray-700 hover:underline">Video</a>
          <a href="#" className="text-gray-700 hover:underline">Kalkulator</a>
          <a href="#" className="text-gray-700 hover:underline">Konsultasi</a>
          <img
            src={ProfilImage}
            alt="Profil User"
      ...
      {/* Footer */}
      <footer className="bg-[#697077] text-white text-sm py-4 flex justify-between items-center px-12 mt-auto">
        ...
        <div className="flex space-x-4">
          ...
          <a href="#" className="text-gray-300 hover:text-white"><FaXTwitter /></a>
