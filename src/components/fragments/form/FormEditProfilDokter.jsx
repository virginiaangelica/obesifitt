    ...
    Swal.fire({
      ...
      html: `
        <div class="flex flex-col items-center space-y-4">
          <img src="src/assets/images 2/profil dokter.jpg" alt="Custom Image" class="mx-auto" style="width: 100px; height: 100px;">
        </div>
      `,
      customClass: {
    ...
    <form className="flex flex-col items-start space-y-6">
      <div className="w-full space-y-4">
        ...
        <div className="w-full flex items-end space-x-2 mt-2">
          ...
          <Button
            ...
            onClick={() => navigate("/gantiemail-dokter")}
          >
            Ganti Email
          </Button>
        </div>
      ...
      <div className="flex flex-col space-y-3 w-full mt-6">
        <div className="flex space-x-4">
          <Button
            className="bg-primary text-white py-2 px-10 rounded-[10px]"
            onClick={handleSave} 
          >
            Simpan
          </Button>
