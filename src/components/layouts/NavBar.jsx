...
export const Navbar = () => {
  return (
    <div className="flex items-center justify-between px-6 py-3 bg-[#f7f7f8] rounded-lg shadow-xl">
      ...
      {/* Login Button */}
      <a href="LoginPage.jsx" className="hidden md:flex items-center justify-center w-[150px] h-[50px] bg-white rounded-full border-2 border-[#90f987] text-sm text-black hover:bg-[#90f987] hover:text-white transition-colors duration-200">
      Masuk
      </a>

      {/* Sign Up Button */}
      <a href="RegisterPage.jsx" className="hidden md:flex items-center justify-center w-[150px] h-[50px] bg-green-500 rounded-full text-sm text-white hover:bg-green-600 transition-colors duration-200">
       Daftar
      </a>
      </div>
